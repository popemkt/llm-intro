...
export function AppSettingsPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text }}>
      ...
      >
        <Breadcrumb segments={[{ label: "Home", to: "/" }, { label: "App Settings" }]} />
      </div>

      <div style={{ maxWidth: 660, margin: "0 auto", padding: "40px 24px" }}>
        <section>
          <div style={{ marginBottom: 20 }}>
            <h2 style={{ fontSize: 13, fontWeight: 700, color: C.text, margin: "0 0 4px 0" }}>
              App Theme
            </h2>
            <p style={{ fontSize: 12, color: C.textDim, margin: 0 }}>
              Styles the shell — nav, panels, backgrounds. Applied instantly.
            </p>
          </div>
