...
const TREE: TreeItem[] = [
  { depth: 0, type: "dir", name: "~/.claude/", desc: "your Claude workspace", icon: FolderOpen },
  {
    ...
    type: "file",
    name: "CLAUDE.md",
    desc: "project instructions & context",
    icon: FileText,
    highlight: false,
  },
  {
    ...
    type: "file",
    name: "settings.json",
    desc: "permissions, hooks, env vars",
    icon: Settings2,
  },
  { depth: 1, type: "dir", name: "commands/", desc: "your skills live here", icon: Folder },
  {
    ...
    type: "file",
    name: "upload.md",
    desc: "/upload — pick up & upload files",
    icon: FileText,
    highlight: true,
  },
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div
          style={{ display: "flex", flexDirection: "column", gap: 8, width: "100%", maxWidth: 580 }}
        >
          {TREE.map((item, i) => {
              ...
              >
                ...
                >
                  <Icon
                    size={13}
                    color={
                      item.highlight ? T.accent : item.type === "dir" ? T.accentDim : T.textDim
                    }
                  />
                </div>
