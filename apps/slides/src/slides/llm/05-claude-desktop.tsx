...
const COMPONENTS = [
  {
    ...
    icon: Brain,
    label: "LLM Core",
    desc: "Claude model — reads context, reasons, generates output",
  },
  {
    id: "tool",
    icon: Cog,
    label: "Tool Executor",
    desc: "Runs tools when LLM output contains a tool call",
  },
  {
    id: "fs",
    icon: Folder,
    label: "File System",
    desc: "Read/write local files — your working directory",
  },
  {
    id: "browser",
    icon: Globe,
    label: "Browser",
    desc: "Open URLs, click buttons, fill forms, take screenshots",
  },
  {
    id: "code",
    icon: Terminal,
    label: "Code Runner",
    desc: "Execute bash/Python/JS scripts directly on your machine",
  },
  {
    id: "mem",
    icon: Database,
    label: "Memory",
    desc: "Persistent context: CLAUDE.md, memory files, conversation history",
  },
];
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: 10.5,
                      fontWeight: 600,
                      color: isHovered ? T.accent : T.text,
