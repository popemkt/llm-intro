...
export function SlideEditor({ pid, slide, theme, onClose, onSaved }: Props) {
  ...
  const removeBlock = useCallback(
    (id: string) => setBlocks((b) => b.filter((x) => x.id !== id)),
    [],
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Live preview strip */}
        <div
          style={{ padding: "12px 20px", borderBottom: `1px solid ${T.border}`, background: T.bg }}
        >
          <div
            style={{
              width: "100%",
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      <div style={{ display: "flex", gap: 8 }}>
        <div style={{ flex: 1 }}>
          ...
          <input
            value={block.width ?? ""}
            onChange={(e) => onChange(block.id, { width: e.target.value || undefined })}
        ...
        <div style={{ flex: 1 }}>
          ...
          <input
            value={block.height ?? ""}
            onChange={(e) => onChange(block.id, { height: e.target.value || undefined })}
